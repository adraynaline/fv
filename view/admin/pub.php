	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        ...
	        <div id="second_step_modele">
	            <form method="post" action="?appli=admin&action=add_pub" id="formPub">
	         		Nom<br/>
		...
		<table class="table table-striped">
			<?php foreach($other_pub as $other): ?>
 			<tr>
 				...
 				<td>
 					<form method="post" action="?appli=admin&action=change_pub" id="formChangePub">
 						<input type="text" id="id" name="id" value="<?php echo $other['id']; ?>">

...
if(isset($_POST))
{
	...
	$DestinationDirectory	= '../../images/issue/'; //specify upload directory ends with / (slash)
	...
	if(resizeImage($CurWidth,$CurHeight,$BigImageMaxSize,$DestRandImageName,$CreatedImage,$Quality,$ImageType))
	{
		...
		*/
		...
		echo '<td width="200px" align="center"><img width="200px" id="min_img_modele" src="images/issue/'.$ThumbPrefix.$NewImageName.'" alt="Thumbnail"></td>';
		echo '</tr><tr>';
		echo '<td align="center">Grande Img 1300px de largeur</td>';
		echo '<td width="200px" align="center"><img width="200px" id="img" src="images/issue/'.$NewImageName.'" alt="Resized Image"></td>';
		echo '</tr>';
		echo '</table>';
